...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "No. Every session is generated by AI specifically for the situation you describe (like \"worried about a presentation tomorrow\"). Because each session is created uniquely for you rather than played from a static library, wording may vary. If a session doesn't quite resonate, you can simply generate a new one anytime.",
    },
    {
